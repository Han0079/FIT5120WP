...
$i++;
$cfg['Servers'][$i]['host'] 			= 'spongebobs-c73715b6405946a2876d9cb58b5510a5-dbserver.mysql.database.azure.com';
$cfg['Servers'][$i]['port'] 			= '';
$cfg['Servers'][$i]['connect_type'] 	= 'tcp';
$cfg['Servers'][$i]['socket'] 			= '';
$cfg['Servers'][$i]['AllowNoPassword']	= false;   // true/false
$cfg['blowfish_secret']					= '<H)=e7B$ApR;f.r:fxo6Q84n&-&^7^\'j' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_svhBrcm9Pq2wtUJuIxMFpfQ/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
