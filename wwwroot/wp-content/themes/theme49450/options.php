...
// ---------------------------------------------------------
			...
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '30px', 'lineheight' => '35px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#fd9029'));
			
			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '22px', 'lineheight' => '22px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#fd9029'));
								
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '18px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#14a9bd'));
			
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#14a9bd'));
								
			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#fd9029'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '40px', 'lineheight' => '37px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#fd9029'));
