		...
		jQuery(function() {
			...
			if (!myCamera.hasClass('motopress-camera')) {
				...
				myCamera.camera({
					...
					height              : '33.4%', //here you can type pixels (for instance '300px'), a percentage (relative to the width of the slideshow, for instance '50%') or 'auto'
					...
					loaderStroke        : 14,    //the thickness both of the pie loader and of the bar loader. Remember: for the pie, the loader thickness must be less than a half of the pie diameter
