...
function water_sports_club_scripts() {
	...
	$custom_css = '
		.logo {
			padding-top: '.esc_attr($water_sports_club_logo_top_padding).'px;
			padding-bottom: '.esc_attr($water_sports_club_logo_bottom_padding).'px;
			padding-left: '.esc_attr($water_sports_club_logo_left_padding).'px;
			padding-right: '.esc_attr($water_sports_club_logo_right_padding).'px;
		}
		#our-services {
			padding-top: '.esc_attr($water_sports_club_courses_section_padding).'px;
			padding-bottom: '.esc_attr($water_sports_club_courses_section_padding).'px;
		}
	';
